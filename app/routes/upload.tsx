...
const Upload = () => {
    ...
    const handleAnalyze = async({companyName, jobTitle, jobDescription, file}: {companyName: string | null, jobTitle: string | null, jobDescription: string | null, file: File | null}) => {
        setIsProcessing(true);
        setStatusText('Uploading your resume...');
        if (!file) {
            setStatusText('No file selected. Please upload your resume.');
      ...
      <section className="main-section">
        <div className="page-heading py-16">
            ...
            {isProcessing ? (
                ...
                <h2>Drop your resume for an ATS scan and get feedback!</h2>
            )}
            {!isProcessing && (
